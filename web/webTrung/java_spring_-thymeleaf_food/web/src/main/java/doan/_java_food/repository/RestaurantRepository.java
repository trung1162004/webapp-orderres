...
public interface RestaurantRepository extends JpaRepository<Restaurant, Long> {
    ...
    @Query(value = "Select distinct (u.id) as data_id, u.* " +
            ...
            " AND (:hot is null or :hot = '' or u.location_id= :hot) " +
            ...
            " AND (:category_id is null or :category_id = '' or rc.category_id IN (:category_id)) " +
            " ORDER BY u.id desc" +
    ...
    @Query(value = "Select count(distinct (u.id)) " +
            ...
            " AND (:category_id is null or :category_id = '' or rc.category_id IN (:category_id)) ",nativeQuery = true)
